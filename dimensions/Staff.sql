...
BEGIN
  ...
  BEGIN
    ...
    BEGIN TRANSACTION;
         ...
         (STAFF_ID, FIRST_NAME, LAST_UPDATE)
         VALUES
         (@V_STAFF_ID, @V_FIRST_NAME, @V_LAST_UPDATE);
