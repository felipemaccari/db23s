-- Análise dos empréstimos realizados por filme ao longo do tempo.

IF EXISTS (
  SELECT * 
  FROM INFORMATION_SCHEMA.ROUTINES 
  WHERE SPECIFIC_NAME = N'PROC_ETL_FT_RENTAL_ANALISE4' 
)
  DROP PROCEDURE PROC_ETL_FT_RENTAL_ANALISE4;

-- PROCEDURE PARA POPULAR FT_RENTAL PARA A ANÁLISE 4
CREATE PROCEDURE DBO.PROC_ETL_FT_RENTAL_ANALISE4
AS
BEGIN
  ...
  FETCH NEXT FROM CUR_GET_RENTAL INTO @TIME, @FILM_ID, @QUANTITY;
  ...
  BEGIN
    ...
    BEGIN TRANSACTION;
      ...
      VALUES (
          @TIME, @FILM_ID, NULL, NULL, NULL, NULL, NULL, NULL, @QUANTITY, 0.00, NULL, NULL
      );
